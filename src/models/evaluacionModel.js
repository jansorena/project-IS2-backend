...
class Evaluacion {
    static async create(id_evaluacion, peso, estatura, grasa, masa_muscular, agua, masa_osea, agua, edad, experencia,
                        id_entrenador, fecha_evaluacion, id_cliente){
                            
                            const result = await db.batch([
                                `INSERT INTO evaluacion (id_evaluacion, peso, estatura, grasa, masa_muscular, agua, masa_osea, agua, edad, experencia) VALUES 
